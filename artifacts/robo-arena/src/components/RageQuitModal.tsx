...
const RAGE_LINES = [
  "YOUR SCRAP HEAP IS COOLING ON THE ARENA FLOOR.",
  "THE CROWD IS BOOING. THEY WANT THEIR MONEY BACK.",
  "NEMESIS STANDS OVER YOUR WRECKAGE. UNIMPRESSED.",
  "CRITICAL SYSTEMS: OFFLINE. PRIDE: OBLITERATED.",
  "YOUR ROBOT IS NOW A PILE OF EXPENSIVE GARBAGE.",
  "ERROR 404: SKILL NOT FOUND.",
  "THE ARENA WILL NOT REMEMBER YOUR NAME.",
];
